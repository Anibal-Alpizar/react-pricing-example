    ...
    <div>
      <div className={`${props.color} "p-12 rounded-xl mb-10>`}>
        <div className="flex flex-col items-center mb-20">
          {props.icon}
          <h2 className={`${props.colorWhite} text-4xl">`}>{props.plan}</h2>
          <p className={`${props.colorDesc} mb-4">`}>{props.description}</p>
          <h5 className={`${props.colorWhite} text-2xl uppercase tracking-[4px] font-bold `}>
            {props.price}
          </h5>
